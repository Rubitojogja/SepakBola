package com.rubito.sepakbola.Adapter;
...
import com.rubito.sepakbola.DetailPemainActivity;
import com.rubito.sepakbola.R;
import com.rubito.sepakbola.Model.PemainModel;
...
public class CardViewPemainAdapter extends RecyclerView.Adapter<CardViewPemainAdapter.CardViewViewHolder> {
    ...
    private CardViewPemainAdapter.OnItemClickCallback onItemClickCallback;
    public void setOnItemClickCallback(CardViewPemainAdapter.OnItemClickCallback onItemClickCallback) {
        this.onItemClickCallback = onItemClickCallback;
    }

    @NonNull
    @Override
    public CardViewPemainAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_pemain, viewGroup, false);
        return new CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final CardViewPemainAdapter.CardViewViewHolder holder, int position) {
